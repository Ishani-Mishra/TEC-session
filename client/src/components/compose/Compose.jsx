...
function Compose(props){
    ...
    return (
        ...
        <h1 className="heading-per-page">CREATE</h1>
                    ...
                    <div className="container ad">
                        ...
                        <form onSubmit={handleSubmit} className="compose-area">
                        {
                            ...
                            <div className="text-area">
                                <textarea type="text" cols="111" rows="10" name="blog" value={ad} placeholder="Use this area to compose your advertisement" onChange={(e) => setAd(e.target.value)}/><br/>
                            </div>
